        ...
        <table style="width: 100%; border-collapse: collapse;">
          <thead>
            <tr style="background-color: #f5f5f5;">
              <th style="padding: 10px; text-align: left; border-bottom: 2px solid #ddd;">Timestamp</th>
          ...
          <tbody>
            <tr style="border-bottom: 1px solid #ddd;">
              <td style="padding: 10px;">2025-05-18 09:15</td>
              <td style="padding: 10px;">admin</td>
              <td style="padding: 10px;">Updated inventory</td>
              <td style="padding: 10px;">Item: Laptop XPS 15 - Stock increased by 10</td>
              <td style="padding: 10px; text-align: center;">
                <span style="background-color: #28a745; color: white; padding: 3px 8px; border-radius: 12px; font-size: 0.85em;">Inventory</span>
              </td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
              <td style="padding: 10px;">2025-05-18 08:45</td>
              <td style="padding: 10px;">user1</td>
              <td style="padding: 10px;">Created order</td>
              <td style="padding: 10px;">Order ID: ORD-20250518-001, Customer: John Doe, Total: $1299.99</td>
              <td style="padding: 10px; text-align: center;">
                <span style="background-color: #007bff; color: white; padding: 3px 8px; border-radius: 12px; font-size: 0.85em;">Order</span>
              </td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
              <td style="padding: 10px;">2025-05-17 16:30</td>
              <td style="padding: 10px;">admin</td>
              <td style="padding: 10px;">Processed return</td>
              <td style="padding: 10px;">Return ID: RET-20250517-001, Order ID: ORD-20250515-003, Item: Monitor Dell P2419H</td>
              <td style="padding: 10px; text-align: center;">
                <span style="background-color: #fd7e14; color: white; padding: 3px 8px; border-radius: 12px; font-size: 0.85em;">Return</span>
              </td>
            </tr>            <tr style="border-bottom: 1px solid #ddd;">
              <td style="padding: 10px;">2025-05-17 10:22</td>
              <td style="padding: 10px;">user2</td>
              <td style="padding: 10px;">Login success</td>
              <td style="padding: 10px;">IP: 192.168.1.105</td>
              <td style="padding: 10px; text-align: center;">
                <span style="background-color: #6c757d; color: white; padding: 3px 8px; border-radius: 12px; font-size: 0.85em;">Login</span>
              </td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd; background-color: #f9f9f9;">
              <td style="padding: 10px;">2025-05-07 10:00</td>
              <td style="padding: 10px;">admin</td>
              <td style="padding: 10px;">Inventory updated</td>
              <td style="padding: 10px;">Item: Dell Inspiron 15 - Stock updated from 5 to 15</td>
              <td style="padding: 10px; text-align: center;">
                <span style="background-color: #28a745; color: white; padding: 3px 8px; border-radius: 12px; font-size: 0.85em;">Inventory</span>
              </td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd; background-color: #f9f9f9;">
              <td style="padding: 10px;">2025-05-06 15:30</td>
              <td style="padding: 10px;">user1</td>
              <td style="padding: 10px;">Order processed</td>
              <td style="padding: 10px;">Order ID: ORD-20250506-002, Customer: Sarah Johnson, Total: $549.99</td>
              <td style="padding: 10px; text-align: center;">
                <span style="background-color: #007bff; color: white; padding: 3px 8px; border-radius: 12px; font-size: 0.85em;">Order</span>
              </td>
            </tr>
